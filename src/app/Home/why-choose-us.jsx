...
export default function whyChooseUs() {
  ...
  return (
      <section className="py-8 sm:py-12 lg:py-[34px]bg-cover bg-center relative"
            style={{ backgroundImage: "url('/assets/image/whyChoose/why_choose_bg.png')" }} >
        <div className="w-full max-w-[1301px] mx-auto px-4 sm:px-6 lg:px-[68px]">
            <div className=" rounded-lg p-4 sm:p-6 lg:p-[22px] space-y-6 sm:space-y-8 lg:space-y-[20px]">
                {/* Section Header */}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-[12px]">
                    {whyChooseUs.map((feature, index) => (
                        <div key={index} className="bg-[#FFFFFF4D] border border-[#FFFFFF4D] backdrop-blur-[10px] rounded-[20px] p-4 sm:p-5 lg:p-[20px] relative overflow-hidden">
                            {/* Background Image */}
                            <Image
                                width={500}
                                height={500}
                            ...
                            {/* Content */}
                            <div className="relative space-y-4 lg:space-y-[18px]">
                                <div className="bg-global-8 rounded-[10px] w-[60px] h-[60px] flex items-center justify-center">
                                    <Image
                                        width={500}
                                        height={500}
                                        src={feature.icon}
